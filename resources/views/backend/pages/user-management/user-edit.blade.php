            ...
            <div class="fv-row mb-7 fv-plugins-icon-container">
                ...
                <div class="d-flex fv-row">
                    <div class="form-check form-check-custom form-check-solid">
                        <input class="form-check-input me-3" name="role" type="radio" value="{{$role->id}}" id="{{$role->name}}" @if(!empty($user->getRoleNames())) @foreach($user->getRoleNames() as $userrole) @if($role->name == $userrole) checked @endif @endforeach @endif required>
